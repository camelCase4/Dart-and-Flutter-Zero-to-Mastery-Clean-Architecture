...
import 'package:task_f10/main.dart';
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(
              icon: Icon(Icons.question_answer), label: "The answer"),
        ],
      ),
      body: Container(
        child: Center(
              ...
              IndexedStack(
                ...
                children: [
                  AnimatedContainer(
                    ...
                    child: Text(
                      firstHints[widget.questionClicked],
                  ...
                  AnimatedContainer(
                    ...
                    duration: const Duration(seconds: 2),
                    child: Text(
                      secondHints[widget.questionClicked],
                      textAlign: TextAlign.center,
                    ),
                  ),
                  AnimatedContainer(
                    ...
                    duration: const Duration(seconds: 2),
                    child: Text(
                      questionAnswers[widget.questionClicked],
                      textAlign: TextAlign.center,
                    ),
                  ),
                ],
