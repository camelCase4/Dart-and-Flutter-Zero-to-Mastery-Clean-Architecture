...
import 'package:todo_app/presentation/pages/create_todo_entry/bloc/create_todo_entry_page_cubit.dart';
...
class CreateToDoEntryPageProvider extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<CreateToDoEntryPageCubit>(
      create: (context) => CreateToDoEntryPageCubit(collectionId: collectionId,addToDoEntry: CreateToDoEntry(toDoRepository: RepositoryProvider.of<ToDoRepository>(context))),
